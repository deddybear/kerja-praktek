<!-- Halaman pendaftaran yang belum diverifikasi -->
...
<script src="{{ asset('halaman/admin/data-ppdb/data-non-verif.js') }}"></script>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Data Pendaftaran (Belum diverifikasi)</h2>
                </div>
